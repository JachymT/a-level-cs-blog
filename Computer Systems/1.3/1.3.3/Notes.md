...
### Protocols
Protocols are sets of rules for procesing data, standardized across the internet to allow for communication between devices and so that signals are universally interpreted the same way.
