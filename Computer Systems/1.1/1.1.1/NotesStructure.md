...
### Data bus
Omnidirectional bus that carries the binary data to and from main memory. This is the data that the CPU has or will process.

### Control bus
Omnidirectional bus that carries control signals and commands to the CPU and other components of the computer. 
